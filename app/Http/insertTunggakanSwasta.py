...
with open('../../public/upload/04 201510 nunggak swasta ada periode tagih.txt', 'rb') as csvfile:
	i = 0
	...
	for row in spamreader:
		if (i==0):
			...
			sql = '''INSERT IGNORE INTO tunggakanswasta (''' + header_string + ''') VALUES (''' + data_string + ''')'''
