	...
	<div class="ui middle aligned stackable grid container">
		<div>
	      ...
	      <h1 class="ui dividing header">
	        ...
	        <div class="content">
	          List Pelanggan Lunas (Pemerintah)
	        </div>
	      </h1>
	    </div>
	    ...
	    <div style="padding:3%;padding-top:0px">
	      ...
	      <table class="ui celled table segment table-hover" id="lunas">
	        <thead>
	          	<tr>
	            	<th width="3%">No.</th>
	            	<th width="10%">ID</th>
...
<script> 
      $(function () {
		...
		var tahun = $("#tahun").val();
		var page = $("#page").val();
		var string_url = "{{url('api/lunas/pemerintah/')}}"
	...
	function getBulan(){
		$("#bulan").empty();
		var tahun = $("#tahun").val();
		var string_url = "{{url('/api/getBulan/lunas/pemerintah')}}"
		string_url += "/"+tahun;
		$.ajax({
			url: string_url,
	...
	function getPage(){
		...
		var tahun = $("#tahun").val();
		var bulan = $("#bulan").val();
		var string_url = "{{url('/api/getPage/lunas/pemerintah')}}"
	...
	$("#exportBtn").click(function(){
		...
		var tahun = $("#tahun").val();
		var page = $("#page").val();
		var string_url = "{{url('export/lunas/pemerintah/')}}"
