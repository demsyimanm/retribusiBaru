...
<div class="ui vertical stripe segment" style="margin-top:100px">
	<div class="ui middle aligned stackable grid container">
    	...
    	<div class="ui stackable grid" style="padding:3%;padding-top:0px">
    		...
    		<div class="two wide column">
    			<div style="padding-top:20px">
			      <!-- <a href="{{url('export/tunggakan/swasta/1/2016')}}"> -->
...
<script> 
      $(function () {
		...
		var tahun = $("#tahun").val();
		var page = $("#page").val();
		var string_url = "{{url('api/lunas/swasta/')}}"
	...
	function getBulan(){
		$("#bulan").empty();
		var tahun = $("#tahun").val();
		var string_url = "{{url('/api/getBulan/lunas/swasta')}}"
		string_url += "/"+tahun;
		$.ajax({
			url: string_url,
	...
	function getPage(){
		...
		var tahun = $("#tahun").val();
		var bulan = $("#bulan").val();
		var string_url = "{{url('/api/getPage/lunas/swasta')}}"
	...
	$("#exportBtn").click(function(){
		...
		var tahun = $("#tahun").val();
		var page = $("#page").val();
		var string_url = "{{url('export/lunas/swasta/')}}"
