...
try:
    ...
    while True:
        try:
            ...
            sql_retribusi = '''select id_retribusi, no_plg, kd_tarif, retribusi from retribusi where status_cek = 0'''
            tanda = 0
            ...
            if (tanda==1):
                ...
                if (unchecked is not None):
                    ...
                    if (str(ret_plg[0]) != str(retribusi) and str(ret_plg[1]) != str(kd_tarif)):
                        ...
                        flag = 0
                    if (flag==1): 
                        update1 = '''update retribusi set status_cek = 1 where id_retribusi = '''+str(id_retribusi)
                        cursor_retribusi.execute(update1)
                        insert1 = '''insert into difference (id_retribusi,no_plg,keterangan) values('''+str(id_retribusi)+''','''+str(no_plg_ret)+''',1)'''
                        ...
                        update1 = '''update retribusi set status_cek = 1 where id_retribusi = '''+str(id_retribusi)
                        cursor_retribusi.execute(update1)
                        insert1 = '''insert into difference (id_retribusi,no_plg,keterangan) values('''+str(id_retribusi)+''','''+str(no_plg_ret)+''',2)'''
                        cursor_retribusi.execute(insert1)
                        db_retribusi.commit()
                        ...
                        update1 = '''update retribusi set status_cek = 1 where id_retribusi = '''+str(id_retribusi)
                        cursor_retribusi.execute(update1)
                        insert1 = '''insert into difference (id_retribusi,no_plg,keterangan) values('''+str(id_retribusi)+''','''+str(no_plg_ret)+''',3)'''
                        cursor_retribusi.execute(insert1)
                        db_retribusi.commit()
                        print 'tidak sama kode tarif '+str(i)
                    elif (flag==0): 
                        update2 = '''update retribusi set status_cek = 1 where id_retribusi = '''+str(id_retribusi)
            ...
            update1 = '''update retribusi set status_cek = 1 where id_retribusi = '''+str(id_retribusi)
            cursor_retribusi.execute(update1)
            insert1 = '''insert into difference (id_retribusi,no_plg,keterangan) values('''+str(id_retribusi)+''','''+str(no_plg_ret)+''',4)'''
